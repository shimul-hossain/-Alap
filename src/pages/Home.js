    ...
    <>
      <div className="flex p-2">
        <div className="flex-auto mb-20 w-[850px] mr-[40px]">
          ...
          {allData.map(item => (
            <div key={item.key} className="postCard bg-white mt-[35px]">
        ...
        <div className="flex-auto w-[290px]">
          <div className="profile bg-white overflow-hidden">
            ...
            <p className='text-center text-[14px] leading-[16.8px] font-bold mx-[30px]'> <Link to={'/profile/'+userId}>Dmitry Kargaev</Link> <span className='inline-block'><AiFillLinkedin/></span></p>
